...
# The number 529 has binary representation 1000010001 and contains two binary gaps: o
# ne of length 4 and one of length 3. The number 20 has binary representation 10100 and contains one binary gap of length 1.
...
# Detected time complexity:O(log(N))
# correctness 100%
